...
var __CSVar_128=CSValue('Ab','string');
var __CSVar_129=CSValue('br','string');
var __CSVar_127=CSOperate_add(__CSVar_128,__CSVar_129);
var __CSVar_123=CSOperate_dynamicRef(__CSVar_124,__CSVar_127);
CSVar(__CSVar_123);
CSEcho('\n');
    return;
}

var __CSVar_132=CSValue('Wow','hdfQuery');
var __CSVar_133=CSValue('Foo','hdfQuery');
var __CSVar_131=CSOperate_dotRef(__CSVar_132,__CSVar_133);
var __CSVar_134=CSValue('4','string');
var __CSVar_130=CSOperate_isEqual(__CSVar_131,__CSVar_134);
if(__CSVar_130){
    CSEcho('\n');
var __CSVar_137=CSValue('Days','hdfQuery');
var __CSVar_138=CSValue('5','hdfQuery');
var __CSVar_136=CSOperate_dotRef(__CSVar_137,__CSVar_138);
var __CSVar_139=CSValue('Abbr','hdfQuery');
var __CSVar_135=CSOperate_dotRef(__CSVar_136,__CSVar_139);
CSVar(__CSVar_135);
CSEcho('\n');
    return;
}

var __CSVar_142=CSValue('Wow','hdfQuery');
var __CSVar_143=CSValue('Foo','hdfQuery');
var __CSVar_141=CSOperate_dotRef(__CSVar_142,__CSVar_143);
var __CSVar_144=CSValue('5','string');
var __CSVar_140=CSOperate_isEqual(__CSVar_141,__CSVar_144);
if(__CSVar_140){
    CSEcho('\n');
var __CSVar_147=CSValue('Days','hdfQuery');
var __CSVar_148=CSValue('6','hdfQuery');
var __CSVar_146=CSOperate_dotRef(__CSVar_147,__CSVar_148);
var __CSVar_149=CSValue('Abbr','hdfQuery');
var __CSVar_145=CSOperate_dotRef(__CSVar_146,__CSVar_149);
CSVar(__CSVar_145);
CSEcho('\n');
    return;
}
...
CSEcho('\n\nbefore echo\n\necho a variable: 3\n');
//call-expand echo
var __CSVar_151=CSValue('Wow','hdfQuery');
var __CSVar_152=CSValue('Foo','hdfQuery');
var __CSVar_150=CSOperate_dotRef(__CSVar_151,__CSVar_152);
CSEcho('\n');
var __CSVar_155=CSValue('Wow','hdfQuery');
var __CSVar_156=CSValue('Foo','hdfQuery');
var __CSVar_154=CSOperate_dotRef(__CSVar_155,__CSVar_156);
var __CSVar_153=CSOperate_forceHDFRef(__CSVar_154);
CSVar(__CSVar_153);
CSEcho('\n');
...
CSEcho('\n');
var __CSVar_159=CSValue('hello world','string');
var __CSVar_158=CSOperate_forceHDFRef(__CSVar_159);
CSVar(__CSVar_158);
CSEcho('\n');
CSEcho('\necho a number: 5\n');
//call-expand echo
var __CSVar_161=CSValue('5','hdfQuery');
var __CSVar_160=CSOperate_forceNumber(__CSVar_161);
CSEcho('\n');
var __CSVar_164=CSValue('5','hdfQuery');
var __CSVar_163=CSOperate_forceNumber(__CSVar_164);
var __CSVar_162=CSOperate_forceHDFRef(__CSVar_163);
CSVar(__CSVar_162);
CSEcho('\n');
CSEcho('\n\n');
CSEcho('\n\necho a variable: 3\n');
//call-expand call_echo
var __CSVar_166=CSValue('Wow','hdfQuery');
var __CSVar_167=CSValue('Foo','hdfQuery');
var __CSVar_165=CSOperate_dotRef(__CSVar_166,__CSVar_167);
CSEcho('\n');
//call-expand echo
var __CSVar_169=CSValue('Wow','hdfQuery');
var __CSVar_170=CSValue('Foo','hdfQuery');
var __CSVar_168=CSOperate_dotRef(__CSVar_169,__CSVar_170);
CSEcho('\n');
var __CSVar_173=CSValue('Wow','hdfQuery');
var __CSVar_174=CSValue('Foo','hdfQuery');
var __CSVar_172=CSOperate_dotRef(__CSVar_173,__CSVar_174);
var __CSVar_171=CSOperate_forceHDFRef(__CSVar_172);
CSVar(__CSVar_171);
CSEcho('\n');
CSEcho('\n');
CSEcho('\necho a string: hellow world\n');
//call-expand call_echo
var __CSVar_175=CSValue('hello world','string');
CSEcho('\n');
//call-expand echo
var __CSVar_176=CSValue('hello world','string');
CSEcho('\n');
var __CSVar_178=CSValue('hello world','string');
var __CSVar_177=CSOperate_forceHDFRef(__CSVar_178);
CSVar(__CSVar_177);
CSEcho('\n');
CSEcho('\n');
CSEcho('\necho a number: 5\n');
...
CSEcho('\n');
//call-expand echo
var __CSVar_182=CSValue('5','hdfQuery');
var __CSVar_181=CSOperate_forceNumber(__CSVar_182);
CSEcho('\n');
var __CSVar_185=CSValue('5','hdfQuery');
var __CSVar_184=CSOperate_forceNumber(__CSVar_185);
var __CSVar_183=CSOperate_forceHDFRef(__CSVar_184);
CSVar(__CSVar_183);
CSEcho('\n');
CSEcho('\n');
CSEcho('\n\n');
...
var __CSVar_187=CSValue('Wow','hdfQuery');
var __CSVar_188=CSValue('Foo','hdfQuery');
var __CSVar_186=CSOperate_dotRef(__CSVar_187,__CSVar_188);
var __CSVar_189=CSValue('error','string');
CSEcho('\n');
//call-expand echo2
var __CSVar_190=CSValue('error','string');
CSEcho('\n');
var __CSVar_192=CSValue('Wow','hdfQuery');
var __CSVar_193=CSValue('Foo','hdfQuery');
var __CSVar_191=CSOperate_dotRef(__CSVar_192,__CSVar_193);
CSVar(__CSVar_191);
CSEcho('\n');
CSEcho('\n');
CSEcho('\necho a string: hellow world\n');
//call-expand call_echo2
var __CSVar_194=CSValue('hello world','string');
var __CSVar_195=CSValue('error','string');
CSEcho('\n');
//call-expand echo2
var __CSVar_196=CSValue('error','string');
CSEcho('\n');
var __CSVar_197=CSValue('hello world','string');
CSVar(__CSVar_197);
CSEcho('\n');
CSEcho('\n');
CSEcho('\necho a number: 5\n');
//call-expand call_echo2
var __CSVar_199=CSValue('5','hdfQuery');
var __CSVar_198=CSOperate_forceNumber(__CSVar_199);
var __CSVar_200=CSValue('error','string');
CSEcho('\n');
//call-expand echo2
var __CSVar_201=CSValue('error','string');
CSEcho('\n');
var __CSVar_203=CSValue('5','hdfQuery');
var __CSVar_202=CSOperate_forceNumber(__CSVar_203);
CSVar(__CSVar_202);
CSEcho('\n');
CSEcho('\n');
CSEcho('\n\nafter echo\n\n');
CSEcho('\n\ntesting macro calls in local vars in an each\n');
var __CSVar_204=CSValue('Days','hdfQuery');
var refer = __CSVar_204;
refer = ToHDF(refer)
for(var index=0;index<refer.nodes.length;index++){
    HdfRef('day',refer.nodes[index]);
    CSEcho('\n');
//call-expand print_day
var __CSVar_205=CSValue('day','hdfQuery');
CSEcho('\n');
var __CSVar_206=CSValue('day','hdfQuery');
CSVar(__CSVar_206);
CSEcho(' == ');
var __CSVar_208=CSValue('day','hdfQuery');
var __CSVar_209=CSValue('Abbr','hdfQuery');
var __CSVar_207=CSOperate_dotRef(__CSVar_208,__CSVar_209);
CSVar(__CSVar_207);
CSEcho('\n');
CSEcho('\n');
//call-expand echo
var __CSVar_211=CSValue('day','hdfQuery');
var __CSVar_212=CSValue('Abbr','hdfQuery');
var __CSVar_210=CSOperate_dotRef(__CSVar_211,__CSVar_212);
CSEcho('\n');
var __CSVar_215=CSValue('day','hdfQuery');
var __CSVar_216=CSValue('Abbr','hdfQuery');
var __CSVar_214=CSOperate_dotRef(__CSVar_215,__CSVar_216);
var __CSVar_213=CSOperate_forceHDFRef(__CSVar_214);
CSVar(__CSVar_213);
CSEcho('\n');
CSEcho('\n');
